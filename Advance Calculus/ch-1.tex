...
$$\exists f(\mathrm{R},<) \rightarrow (\mathrm{R},<') \text{ such that}$$
	...
	\text{Note.} In most book, above theorem is taken as axiom, called the least upper bound property of $\R$ or the completeness axiom of $\R$. However, it can be constructed from $\Q$. There are two ways to construct it
